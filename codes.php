...
<main>
	...
	<div class="codes">
		<div class="container">
			<h3 class="title wow slideInDown animated" data-wow-delay=".7s">Short Codes</h3>
			...
			<div class="grid_3 grid_4 agile wow fadeInDown animated" data-wow-delay=".5s">
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td class="type-info w3agile">Semibold 12px</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="grid_3 grid_5 wow fadeInDown animated" data-wow-delay=".5s">
				<h3 class="hdg agileinfo">Progress Bars</h3>
